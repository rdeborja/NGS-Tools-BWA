package NGS::Tools::BWA::Roles::Core;
use Moose::Role;
...
NGS::Tools::BWA::Roles::Core

=head1 SYNOPSIS

A Perl Moose role that contains core attributes and methods for the BWA aligner.
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc NGS::Tools::BWA::Roles::Core
...
1; # End of NGS::Tools::BWA::Roles::Core
